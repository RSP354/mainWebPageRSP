...
const Propuesta = () => {
   ...
   {/* Funcion mtns de Hero Propuesta */}

	const segmentsTl = [
		{ text: 'Trazando tu ', color: '' },
		{ text: 'rumbo',       color: 'text-lime-400' },
		{ text: ' hacia el éxito', color: '' },
	  ];
	  ...
	  {/*funcion mtns de step by step */}

	  const containerVariantsSteps = {
		hidden: { opacity: 0 },
		visible: {
		  opacity: 1,
		  transition: {
   ...
   <>
	...
	className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
		<div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
			<motion.h1 className="text-5xl font-bold leading-none sm:text-6xl"
			variants={containerTl}
			initial="hidden"
			whileInView="visible"
			viewport={{ once: true }} >

				{segmentsTl.map(({ text, color }) =>
	...
	<div className="container mx-auto  flex flex-col p-6 ">
		<motion.h2
		 ...
		 transition={{ duration: 1}}
		 viewport={{ once: true }}
		className="py-4 text-3xl font-bold text-center mt-14">
			Próximos pasos
		</motion.h2>
		...
		<motion.div 
		  initial="hidden"
		  whileInView="visible"
		  variants={containerVariantsSteps}
		  viewport={{ once: true, amount: 0.1}}
		  className="divide-y divide-gray-300 mt-20">

			<motion.div 
			  variants={itemVariantsSteps}
